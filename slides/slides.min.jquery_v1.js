...
(function(jQuery){
	jQuery.fn.slides = function( option ) {
		...
		return this.each(function(){
			...
			// loop
			if(option.loop !='' && isNum(option.loop)){
				if (loopCount == option.loop) {				
					stop();
				}
			}
	...
	jQuery.fn.slides.option = {
		...
		loop: '', // number, blank loops any number equals the times the slide show will loop
